...
SDL_Surface* gBalls[14];			//The coloured ball images
...
void SDLLib::loadMedia(){
	...
	gBalls[10]=IMG_Load("img/up.png");
	gBalls[11]=IMG_Load("img/right.png");
	gBalls[12]=IMG_Load("img/down.png");
	gBalls[13]=IMG_Load("img/left.png");
